    ...
    >
      <RevealOnScroll>
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-4 border-blue-500 hover:-translate-y-1 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="p-6 rounded-xl border-4 border-blue-500 hover:-translate-y-1 transition-all">
